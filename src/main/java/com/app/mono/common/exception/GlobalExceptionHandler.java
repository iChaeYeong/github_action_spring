...
public class GlobalExceptionHandler  extends ResponseEntityExceptionHandler {
    ...
    // DTO Validation 실패(@Valid 및 @Validated) 처리
    @Override
    ...
    @ExceptionHandler({CardAlreadyExistsException.class, CustomerAlreadyExistsException.class, LoanAlreadyExistsException.class})
